 <template>
  <div>
    ...
    <main class="main-section">
      <!--Inicio de contenido de la página team-->
            ...
            <b-card>
              <div class="team-one">
                ...
                <b-text>
                  ...
                  <h5 class="occupation">
                    Desarrollador backend y frontend, diseñador web
                  </h5>
                  <b-button
              ...
              <div class="team-three">
                ...
                <b-text>
                  ...
                  <p class="info">
                    ...
                    aprendizaje del mundo del desarrollo
                  </p>
                  <h5 class="occupation">
                    Diseñadora web y desarrolladora frontend
                  </h5>
                  <b-button
                    href="https://github.com/muakarada"
                    target="_blank"
                    class="contact-team"
                    >Contacto</b-button
                  >
            ...
            <b-card>
              <div class="team-four">
                ...
                <b-text>
                  ...
                  <b-button
                    href="https://github.com/lufermaxi"
                    target="_blank"
                    class="contact-team"
                    >Contacto</b-button
                  >
